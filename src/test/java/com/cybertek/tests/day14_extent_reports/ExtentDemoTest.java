...
public class ExtentDemoTest {
    ...
    public void setUp(){
        ...
        String projectPath = System.getProperty("user.dir"); //projenin nerede oldugunu bulmanin dynamic yolu
        String path = projectPath + "/test-output/report.html"; //report.html degisken olacak is yerinde
