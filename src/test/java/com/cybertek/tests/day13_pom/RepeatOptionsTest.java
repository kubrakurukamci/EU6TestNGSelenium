...
public class RepeatOptionsTest extends TestBase {
   ...
   * */
    ...
    public void test1() {
        ...
        //calendarEventsPage.waitUntilLoaderScreenDisappear(); hata verirse bekleme icin diye hazirda bekliyor
        BrowserUtils.waitForClickablility(calendarEventsPage.createCalendarEvent, 5);//wait hatasi icin bu methodu kullanabiliriz
    ...
    public void test2() {
        ...
        //kisa yolu ise //browser util den yukaridaki methodu surekli kullanmak uzere cagiririz
